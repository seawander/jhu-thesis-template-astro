...
${fname}.pdf: ${fname}.tex \
	...
	intro_chapter/intro_chapter.bib \
        chapter_apj/apj_chapter.tex \
        chapter_apj/apj_chapter.bib \
        chapter_apj_dup/apj_dup_chapter.tex \
        chapter_apj_dup/apj_dup_chapter.bib \
	...
	bibtex ${fname}3-blx
	bibtex ${fname}4-blx
	#bibtex ${fname}5-blx  #example when you have more chapters
	#bibtex ${fname}6-blx
	# Add more if you have more chapters
	pdflatex ${fname}
	pdflatex ${fname}
	cp ${fname}.pdf Your_Thesis.pdf
	open Your_Thesis.pdf #change the pdf name if you want
clean:
	if [ -e ${fname}.aux ]; \
	then \
	rm *.aux; \
